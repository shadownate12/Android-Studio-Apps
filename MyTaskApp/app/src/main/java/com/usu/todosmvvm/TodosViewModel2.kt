...
class TodosViewModel2: ViewModel() {
    ...
    private fun loadTodos() {
        viewModelScope.launch {
            val loadedTodos = TodosRepository2.getAllTodos()
    ...
    fun createTodo(todoInput: String) {
        ...
        viewModelScope.launch {
            ...
            todo.id = TodosRepository2.createTodo(todo).toInt();
            todos.add(todo)
        }
    }
    ...
    fun removeTodo(){
        ...
        //Remove Todo
        viewModelScope.launch {
            TodosRepository2.remove(todos[0])
            todos.removeFirst()
        }
