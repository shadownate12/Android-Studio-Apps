...
//        val hasKey: Boolean = state["hasKey"]; // get whether the player has the key or not
        ...
        canvas.drawCircle(cellSize/2.toFloat(), cellSize/2.toFloat(), cellSize.toFloat()/4 + 10, paint)
        paint.color = Color.YELLOW
        canvas.drawCircle(cellSize/2.toFloat(), cellSize/2.toFloat(), cellSize.toFloat()/4, paint)
        paint.color = Color.BLACK
        canvas.drawRect(55f, 60f, 70f, 70f, paint)
        canvas.drawRect(85f, 60f, 100f, 70f, paint)
        canvas.drawCircle(cellSize/2.toFloat(), cellSize/2 + 15f, 15f, paint)
    }
